...
export async function seedDatabase(dataSource) {
    ...
    for (const p of productSeeds) {
        ...
        const saved = (await productRepo.save(productRepo.create({ tenant_id: tenantId, is_active: true, ...productData })));
    ...
    const flashSale = await flashSaleRepo.save(flashSaleRepo.create({
        tenant_id: tenantId,
